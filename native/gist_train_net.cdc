...
channel net.c0 -> net.c3 weight=0.5 delay=0.0 angle=0.0 lines=1 plastic=1 rate=0.05
channel net.c1 -> net.c3 weight=0.5 delay=0.0 angle=0.0 lines=1 plastic=1 rate=0.05
channel net.c1 -> net.c4 weight=0.5 delay=0.0 angle=0.0 lines=1 plastic=1 rate=0.05
channel net.c2 -> net.c4 weight=0.5 delay=0.0 angle=0.0 lines=1 plastic=1 rate=0.05
channel net.c3 -> net.c5 weight=0.5 delay=0.0 angle=0.0 lines=1 plastic=1 rate=0.05
channel net.c4 -> net.c5 weight=0.5 delay=0.0 angle=0.0 lines=1 plastic=1 rate=0.05
